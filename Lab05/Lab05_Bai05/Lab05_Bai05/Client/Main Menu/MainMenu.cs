...
namespace Lab04_Bai07.Client.Main_Menu
{
    public partial class MainMenu : Form
    {
        ...
        private void button_OpenEmail_Click(object sender, EventArgs e)
        {
            // Khởi tạo form EmailContribution
            var emailForm = new Lab04_Bai07.Client.Email.EmailContribution();

            // Hiển thị form dưới dạng Dialog (cửa sổ con)
            emailForm.ShowDialog();

            // Sau khi đóng form Email, tự động tải lại danh sách món ăn
            // để các món vừa tải từ Email hiện lên ngay lập tức
            LoadFoodList();
        }
    }
}